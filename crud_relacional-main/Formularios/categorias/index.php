...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE SUCURSAL</h1>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['Horario'] ?></th>
                            <th scope="row"><?php echo $resultado['Contacto'] ?></th>
                            <th scope="row"><?php echo $resultado['Municipio'] ?></th>
                            <th scope="row"><?php echo $resultado['Colonia'] ?></th>
                            <th scope="row"><?php echo $resultado['Avenida'] ?></th>
                            <th scope="row"><?php echo $resultado['Numero'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?Id=<?php echo $resultado['idSucursales'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['idSucursales'] ?>" class="btn btn-outline-danger">
