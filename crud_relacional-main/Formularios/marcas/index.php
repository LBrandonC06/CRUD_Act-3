...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE DUENO</h1>
        <div class="table-responsive-sm">
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">Nombre_D</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['C_Postal'] ?></th>
                            <th scope="row"><?php echo $resultado['Colonia'] ?></th>
                            <th scope="row"><?php echo $resultado['N_Ext'] ?></th>
                            <th scope="row"><?php echo $resultado['N_Int'] ?></th>
                            <th scope="row"><?php echo $resultado['Telefono'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/marcas/actualizar.php?Id=<?php echo $resultado['idUsuario'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?Id=<?php echo $resultado['idUsuario'] ?>" class="btn btn-outline-danger">
