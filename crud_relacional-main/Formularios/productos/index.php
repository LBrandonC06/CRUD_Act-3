...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE SERVICIOs</h1>
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    INNER JOIN categorias ON productos.categoriaId = categorias.idSucursales
                    INNER JOIN marcas ON productos.marcaId = marcas.idUsuario");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['nombreServisio'] ?></th>
                            <th scope="row"><?php echo $resultado['problema'] ?></th>
                            <th scope="row"><?php echo $resultado['Telefonos'] ?></th>
                            <th scope="row"><?php echo $resultado['municipio'] ?></th>
                            <th scope="row"><?php echo $resultado['F_Solicitud'] ?></th>
                            <th scope="row">
